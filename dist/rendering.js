...
function link(scope, elem, attrs, ctrl) {
  ...
  var $tooltip = (0, _jquery.default)('<div id="tooltip">');
  ...
  function addPieChart() {
    ...
    var plotCanvas = (0, _jquery.default)('<div></div>');
    var plotCss = {
      margin: 'auto',
      position: 'relative',
      paddingBottom: 20 + 'px',
    ...
    var backgroundColor = (0, _jquery.default)('body').css('background-color');
    var options = {
      legend: {
        show: false
      },
    ...
    _jquery.default.plot(plotCanvas, data, options);
    ...
    plotCanvas.bind("plothover", function (event, pos, item) {
      ...
      body += '<div class="piechart-tooltip-value">' + _lodash.default.escape(item.series.label) + ': ' + formatted;
      body += " (" + percent + "%)" + '</div>';
      body += "</div></div>";
